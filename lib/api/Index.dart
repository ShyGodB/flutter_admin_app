...
// import 'package:flutter_admin_app/config/index.dart';
import 'package:shared_preferences/shared_preferences.dart';
// import 'package:flutter_admin_app/config/$global.env';
...
class API {
  ...
  dynamic post(String url, data) async {
    ...
    Response res = await Dio()
        .post(reqUrl, data: data, options: Options(headers: httpHeaders));
    return res.data;
  }
}
